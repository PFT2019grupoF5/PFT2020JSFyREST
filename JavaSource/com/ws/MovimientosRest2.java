...
public class MovimientosRest2 {
    ...
    @Path("/update/{id}")
    @Produces(MediaType.APPLICATION_JSON)
    	// aca siguiendo la logica del teorico deberia decir solo Movimiento movimiento como parametro
      public void updateMovimiento(@PathParam("id") Long id, Movimiento movimiento) throws ServiciosException{
        try{
    ...
    @Path("/delete/{id}")
    @Produces(MediaType.APPLICATION_JSON)
    public void deleteMovimiento(@PathParam("id") Long id) throws ServiciosException {
		try{
